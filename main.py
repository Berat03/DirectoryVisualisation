...
https://github.com/mauriziodimatteo/dirtreex
"""

# https://stackoverflow.com/questions/21116302/python-directory-and-file-list-tree-structure-ouput

# How can I filter which directories I want?
    # Ignore: Python .venv, .git
    # Trial and error?
import os
